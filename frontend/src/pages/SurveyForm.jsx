...
export default function SurveyForm() {
  ...
  const handleCheckSir = async () => {
    ...
    try {
      ...
      const SIR_URL = (process.env.REACT_APP_API_URL || 'https://production-web-conn-bzpt.onrender.com') + '/api/sir/check/';
  ...
  const handleCheckBjp = async () => {
    ...
    try {
      const BJP_URL = (process.env.REACT_APP_API_URL || 'https://production-web-conn-bzpt.onrender.com') + '/api/bjp/check/';
