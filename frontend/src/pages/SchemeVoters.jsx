...
const VOTER_KEYS = ['VoterID','House_No','MobileNumber','DOB','AGE','Gender','Religion','Community','SubCategory','EconomicStatus','EmploymentStatus','EmploymentType','HealthStatus','PhysicalStatus','HomeType','MaritalStatus','Education','EducationType','AnnualIncome','WardNumber','BoothNo'];
            ...
            {filtered.map((voter, i) => (
              <div key={voter.VoterID||i} className="card voter-card" onClick={() => openVoter(voter)}>
                ...
                <div className="voter-info">
                  ...
                  <div className="voter-meta">{voter.Religion} · {voter.EconomicStatus} · {voter.Gender} · Age {voter.AGE}</div>
                </div>
